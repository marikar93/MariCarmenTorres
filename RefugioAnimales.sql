...
CREATE TABLE `animales` (
  ...
  `fechaAdopcion` varchar(45) DEFAULT NULL,
...
INSERT INTO `raza` VALUES (1,'angora'),(2,'bengala'),(3,'americano'),(4,'escoces'),(5,'siames'),(6,'egipcio'),(7,'persa'),(8,'tigre'),(9,'galgo'),(10,'terrier'),(11,'cocker'),(12,'pero de agua'),(13,'pastor aleman'),(14,'buldog frances'),(15,'chihuahua'),(16,'chow chow'),(17,'perro salchicha'),(18,'doberman'),(19,'husky siberiano'),(20,'yorsike');
...
INSERT INTO `tipousuario` VALUES (1,'Fundador/socio'),(2,'voluntario/adoptante');
...
INSERT INTO `usuario` VALUES (1,'marikar','marikar93','20225052w','Mari Carmen','marikar_93@hotmail.com',638162833,'c/Franz kafka',123456,1),(2,'maria','msperez','25635481x','Maria','mssibaja@hotmail.com',655485216,'c/la union',NULL,2);
